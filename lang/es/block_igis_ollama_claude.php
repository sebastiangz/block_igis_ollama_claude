...
/**
 * Language strings for Multi-provider AI Chat Block (Spanish)
 *
...
$string['pluginname'] = 'Chat IA Multi-proveedor';
$string['igis_ollama_claude:addinstance'] = 'Añadir un nuevo bloque de Chat IA Multi-proveedor';
$string['igis_ollama_claude:myaddinstance'] = 'Añadir un nuevo bloque de Chat IA Multi-proveedor al Tablero';
$string['igis_ollama_claude:viewlogs'] = 'Ver registros del Chat IA Multi-proveedor';
...
$string['openaiapi'] = 'OpenAI (nube)';
$string['geminiapi'] = 'Gemini (nube)';
...
$string['ollamamodelhelp'] = 'El nombre del modelo a utilizar en Ollama (p.ej., claude, llama2, mistral, etc.)';
...
$string['openaisettings'] = 'Configuración API OpenAI';
$string['openaikey'] = 'Clave API OpenAI';
$string['openaikeyhelp'] = 'Su clave API de OpenAI para acceder al servicio en la nube';
$string['openaimodel'] = 'Modelo OpenAI';
$string['openaimodelhelp'] = 'El modelo de OpenAI a utilizar (p.ej., gpt-4, gpt-3.5-turbo)';

// Configuración API - Gemini
$string['geminisettings'] = 'Configuración API Gemini';
$string['geminikey'] = 'Clave API Gemini';
$string['geminikeyhelp'] = 'Su clave API de Google Gemini para acceder al servicio en la nube';
$string['geminimodel'] = 'Modelo Gemini';
$string['geminimodelhelp'] = 'El modelo de Gemini a utilizar (p.ej., gemini-pro, gemini-1.5-pro)';
...
$string['assistantnamedesc'] = 'El nombre que se mostrará para el asistente IA en el chat';
$string['defaultassistantname'] = 'Asistente IA';
$string['username'] = 'Nombre de usuario';
$string['usernamedesc'] = 'El nombre que se mostrará para el usuario en el chat';
...
$string['noapiurlsetupadmin'] = 'Chat IA Multi-proveedor no ha sido configurado aún. <a href="{$a}">Configura la API</a> para comenzar.';

// Strings para privacidad
$string['privacy:metadata:block_igis_ollama_claude_logs'] = 'Información sobre las interacciones de los usuarios con el asistente IA';
...
$string['privacy:metadata:openai_api'] = 'Para integrarse con OpenAI, algunos datos deben enviarse al servicio API OpenAI';
$string['privacy:metadata:openai_api:message'] = 'El mensaje enviado por el usuario';
$string['privacy:metadata:openai_api:prompt'] = 'El prompt del sistema utilizado para guiar el comportamiento de la IA';
$string['privacy:metadata:openai_api:sourceoftruth'] = 'Los datos de la fuente de verdad utilizados para proporcionar información precisa';
$string['privacy:metadata:gemini_api'] = 'Para integrarse con Gemini, algunos datos deben enviarse al servicio API Gemini';
$string['privacy:metadata:gemini_api:message'] = 'El mensaje enviado por el usuario';
$string['privacy:metadata:gemini_api:prompt'] = 'El prompt del sistema utilizado para guiar el comportamiento de la IA';
$string['privacy:metadata:gemini_api:sourceoftruth'] = 'Los datos de la fuente de verdad utilizados para proporcionar información precisa';
...
$string['report'] = 'Informe de chat de IA';
