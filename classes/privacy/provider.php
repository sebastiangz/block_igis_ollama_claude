...
/**
 * Privacy Subsystem implementation for Ollama Claude AI Chat Block
 *
...
/**
 * Privacy provider for the Ollama Claude AI Chat Block
 *
 * @copyright  2025 Sebastián González Zepeda <sgonzalez@infraestructuragis.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        $sql = "SELECT cl.id, cl.courseid, cl.contextid, cl.instanceid, cl.message, cl.response, 
                       cl.sourceoftruth, cl.prompt, cl.model, cl.timecreated, c.fullname as coursename,
                       bi.blockname
